...
def helpnote():
	...
	subprocess.check_output(["am", "start", "plr = requests.get('https://github.com/Jahid-444/OLD-ID/blob/main/Approval.txt').text"])
	exit(" [*] FACEBOOK :  JAHID JAHID ")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰JAHID")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Jahid-444/OLD-ID/blob/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : Jahid Hasan
\033[1;91m [\033[1;94m✓\033[1;91m]
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : Jahid-444
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01865508461
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX: JAHID): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [JAHID_OLD] : %s/%s -> \033[0;92m [ JAHID-OK:%s ]- \033[0;91m[JAHID-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
